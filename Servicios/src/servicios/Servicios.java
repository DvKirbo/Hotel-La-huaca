...
public class Servicios {
    ...
    for (int i = 0; i < servicios.size(); i++) {
        ...
        if (servicio.nombre.equals(nombreBorrar)) {
            servicios.remove(i);
            System.out.println("Servicio borrado con éxito.");
            return;
        }
    }

    System.out.println("El servicio no existe. No se pudo borrar.");
}
    ...
    private static void actualizarServicio(Scanner scanner, ArrayList<Servicio> servicios) {
        ...
        System.out.println("El servicio no existe. No se pudo actualizar.");
    }
